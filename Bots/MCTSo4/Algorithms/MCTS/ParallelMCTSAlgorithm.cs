...
namespace MCTSo4.Algorithms.MCTS
{
    ...
    public static class ParallelMctsAlgorithm
    {
        ...
        )
        {
            ...
            {
                AlgoLog.Error(
                    "FindBestMove called with Guid.Empty BotId. Returning a random move."
                );
        ...
        )
        {
            ...
            // 3. Simulation phase
            SimulationResult result = SimulateWithHeuristics(
                selectedNode,
                botId,
                parameters,
                random
        ...
        private static Move SelectBestMove(ThreadSafeNode root, Guid botId)
        {
            ...
            AlgoLog.Information(
                ...
                highestWinRateNode.Visits > 0
                    ? highestWinRateNode.Wins / highestWinRateNode.Visits
                    : 0,
