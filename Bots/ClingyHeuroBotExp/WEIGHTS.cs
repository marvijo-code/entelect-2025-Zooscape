...
public static class WEIGHTS
{
    ...
    // Movement optimization heuristics
    public const decimal PreviousPositionPenalty = 2.5m;
    public const decimal MovementConsistency = 1.8m;
    public const decimal OptimalPelletPathEfficiency = 3.0m; // High weight to prioritize efficient pellet collection
